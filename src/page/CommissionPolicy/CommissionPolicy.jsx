      ...
      <section className='commission-policy'>
        ...
        <div>
          <ul>
            ...
            <li>Please contact me via discord Shigeru-chan#2584 or directly contact my email 2546113944@qq.com or with Question Form if you'd like to be added to the waiting list.</li>
            <li>If you feel unsure if I can draw some certain character(s) for you or not, please don’t hesitate to consult with me first like the method above with provide me some pictures sample that you want me to draw and some descriptions.</li>
            <li>Please provide clear illustrated + colored reference pictures of character you want me to draw. I do not accept text descriptions only as reference because I will get lost and make a lot of mistakes.</li>
            <li>If you would like some certain size / dimension for the artwork, please let me know when you fill the commission form.</li>
            <li>I have the right to decline the commission offer if I think I can't work on it or beyond my ability or I feel uncomfortable to work for you.</li>
            <li>If you feel unsure if I can draw some certain character(s) for you or not, please don’t hesitate to consult with me first via Question Form with provide me some pictures sample that you want me to draw and some descriptions.</li>
        ...
        <ul>
          ...
          <li>I am a slow illustrator, so please don't hurry me to deliver you the best quality.</li>
        ...
        <ul>
          <li>The commissioner / my client have the rights to repost the commissioned art to other site (with credit to my page), use it as decoration for your social media, and printing / merchandising it as long as you're not selling and making any profit with it (if you order for personal use only).</li>
          ...
          <li>Progress of the commissions will be available to view in my commission progress document. You may ask for a WIP preview anytime while I'm working on yours. You will get a downsized, watermarked version of the image for preview.</li>
        ...
        <ul>
          ...
          <li>- rough sketch finished (50% will be given back) + the image file at the moment progress - lining started (40% will be given back) + the image file at the moment progress - base color started (20% will be given back) + the image file at the moment progress - shading started & commission completed (0% will be given back) + the image file at the moment progress</li>
        ...
        <ul>
          <li>As an artist, my art is constantly evolving, so there might be slight differences between the samples in my gallery and the illustration you will receive (linearts style, coloring method, composition...)</li>
          <li>I will work as best as I can, but you're the one who have to make sure that whatever you order is suitable with my style so you clian avoid any dissatisfaction. Please browse around my gallery for samples.</li>
          <li>If you wish to tip me for doing a good job (as I know it is a custom in some countries or you are really satisfied with the result) you can do it via kofi or paypal. I will deeply appreciate it ♥</li>
